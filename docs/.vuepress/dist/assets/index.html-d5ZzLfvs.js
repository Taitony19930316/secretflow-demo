import{_ as C,c as w,b as x,a as d,o as M}from"./app-BaaRCFO7.js";typeof window<"u"&&(window.runMPC=async function(){const a=parseFloat(document.getElementById("dataA").value)||100,s=parseFloat(document.getElementById("dataB").value)||200,e=parseFloat(document.getElementById("dataC").value)||300,o=document.getElementById("result");o.innerHTML=`
      <div style="text-align: center; padding: 30px; font-size: 1.2em; color: #666;">
        🔄 正在进行秘密分享和联合计算...
      </div>
    `,await new Promise(y=>setTimeout(y,1e3));const n=Math.floor(Math.random()*a),i=Math.floor(Math.random()*(a-n)),c=a-n-i,l=Math.floor(Math.random()*s),r=Math.floor(Math.random()*(s-l)),h=s-l-r,t=Math.floor(Math.random()*e),p=Math.floor(Math.random()*(e-t)),u=e-t-p,g=n+l+t,v=i+r+p,b=c+h+u,m=g+v+b,f=(m/3).toFixed(2);o.innerHTML=`
      <div style="background: #f8f9ff; padding: 25px; border-radius: 12px; margin-top: 20px;">
        ...
        <div style="background: white; padding: 20px; border-radius: 10px; margin: 15px 0; border-left: 5px solid #667eea;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; font-size: 1em;">
            <div style="background: #e3f2fd; padding: 15px; border-radius: 8px;">
              <div style="font-weight: bold; color: #1976d2; margin-bottom: 8px;">参与方 A (${a})</div>
              <div style="color: #555;">份额1: ${n}</div>
              <div style="color: #555;">份额2: ${i}</div>
              <div style="color: #555;">份额3: ${c}</div>
            </div>
            <div style="background: #f3e5f5; padding: 15px; border-radius: 8px;">
              <div style="font-weight: bold; color: #7b1fa2; margin-bottom: 8px;">参与方 B (${s})</div>
              <div style="color: #555;">份额1: ${l}</div>
              <div style="color: #555;">份额2: ${r}</div>
              <div style="color: #555;">份额3: ${h}</div>
            </div>
            <div style="background: #fce4ec; padding: 15px; border-radius: 8px;">
              <div style="font-weight: bold; color: #c2185b; margin-bottom: 8px;">参与方 C (${e})</div>
              <div style="color: #555;">份额1: ${t}</div>
              <div style="color: #555;">份额2: ${p}</div>
              <div style="color: #555;">份额3: ${u}</div>
            </div>
          </div>
        </div>
        ...
        <div style="background: white; padding: 20px; border-radius: 10px; margin: 15px 0; border-left: 5px solid #764ba2;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; font-size: 1em;">
            <div style="background: #e1f5fe; padding: 15px; border-radius: 8px;">
              ...
              <div style="color: #555;">a₁(${n}) + b₁(${l}) + c₁(${t})</div>
              <div style="font-size: 1.3em; font-weight: bold; color: #01579b; margin-top: 10px;">= ${g}</div>
            </div>
            <div style="background: #f1f8e9; padding: 15px; border-radius: 8px;">
              ...
              <div style="color: #555;">a₂(${i}) + b₂(${r}) + c₂(${p})</div>
              <div style="font-size: 1.3em; font-weight: bold; color: #33691e; margin-top: 10px;">= ${v}</div>
            </div>
            <div style="background: #fff3e0; padding: 15px; border-radius: 8px;">
              <div style="font-weight: bold; color: #e65100; margin-bottom: 8px;">C 手里的份额</div>
              <div style="color: #555;">a₃(${c}) + b₃(${h}) + c₃(${u})</div>
              <div style="font-size: 1.3em; font-weight: bold; color: #e65100; margin-top: 10px;">= ${b}</div>
            </div>
          </div>
        </div>
        ...
        <div style="background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%); padding: 20px; border-radius: 10px; margin: 15px 0; border: 2px solid #4caf50;">
          ...
          <div style="font-size: 1.1em; color: #1b5e20; margin-bottom: 15px;">
            ${g} + ${v} + ${b} = <span style="font-size: 1.5em; font-weight: bold;">${m}</span>
          </div>
          <div style="font-size: 1.3em; color: #1b5e20; font-weight: bold;">
            平均值 = ${m} ÷ 3 = <span style="font-size: 1.5em; color: #4caf50;">${f}</span>
          </div>
        </div>
    ...
    `});const k={};function P(a,s,e,o,n,i){return M(),w("div",null,[...s[0]||(s[0]=[x(`<h1 id="mpc" tabindex="-1"><a class="header-anchor" href="#mpc"><span>MPC</span></a></h1><blockquote><p>Multi-Party Computation - 让数据联合计算，价值不设边界</p></blockquote><hr><h2 id="场景痛点" tabindex="-1"><a class="header-anchor" href="#场景痛点"><span>场景痛点</span></a></h2><h3 id="联合计算的根本困境" tabindex="-1"><a class="header-anchor" href="#联合计算的根本困境"><span>联合计算的根本困境</span></a></h3><p>在数据协作中，<strong>仅仅知道交集是不够的</strong>。更多场景需要在保护隐私的前提下，进行复杂的联合计算。</p><h4 id="更复杂的计算需求" tabindex="-1"><a class="header-anchor" href="#更复杂的计算需求"><span>更复杂的计算需求</span></a></h4><ul><li><strong>联合统计分析</strong>：多方数据的求和、平均值、方差</li><li><strong>联合风险评估</strong>：基于多方数据的综合评分</li><li><strong>联合决策</strong>：多方共同参与的复杂计算逻辑</li></ul><h4 id="psi-的局限性" tabindex="-1"><a class="header-anchor" href="#psi-的局限性"><span>PSI 的局限性</span></a></h4><ul><li><strong>功能单一</strong>：只能计算交集，无法支持其他运算</li><li><strong>信息有限</strong>：只知道&quot;有没有&quot;，不知道&quot;是多少&quot;</li><li><strong>场景受限</strong>：很多业务需要更复杂的协作</li></ul><h4 id="传统方案的根本缺陷" tabindex="-1"><a class="header-anchor" href="#传统方案的根本缺陷"><span>传统方案的根本缺陷</span></a></h4><table><thead><tr><th>方案</th><th>本质问题</th><th>结果</th></tr></thead><tbody><tr><td><strong>中心化计算</strong></td><td>数据全部集中到一方</td><td>❌ 数据泄露风险，违反合规</td></tr><tr><td><strong>明文交换</strong></td><td>数据直接共享</td><td>❌ 隐私全失，无法接受</td></tr><tr><td><strong>可信第三方</strong></td><td>信任单点风险</td><td>⚠️ 第三方可能作恶</td></tr></tbody></table><h4 id="核心矛盾" tabindex="-1"><a class="header-anchor" href="#核心矛盾"><span>核心矛盾</span></a></h4><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">联合计算需求 ⇄ 数据不能出本地</span>
<span class="line">      ↓</span>
<span class="line">  传统方案失效</span>
<span class="line">      ↓</span>
<span class="line">   MPC 技术登场</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>本质问题：</strong></p><ul><li><strong>想要：</strong> 联合计算得到结果</li><li><strong>不能：</strong> 泄露各方原始数据</li><li><strong>传统技术：</strong> 要么不计算，要么不隐私</li><li><strong>MPC 方案：</strong> 计算和隐私可以兼得</li></ul><hr><h2 id="技术原理" tabindex="-1"><a class="header-anchor" href="#技术原理"><span>技术原理</span></a></h2><h3 id="什么是-mpc" tabindex="-1"><a class="header-anchor" href="#什么是-mpc"><span>什么是 MPC？</span></a></h3><p>MPC（Multi-Party Computation，多方安全计算）允许多方在<strong>不泄露各自输入</strong>的情况下，共同计算一个函数，得到<strong>正确的输出结果</strong>。</p><p><strong>核心特点：</strong></p><ul><li><strong>输入隐私</strong>：各方的原始数据不会泄露</li><li><strong>计算正确</strong>：最终结果和明文计算完全一致</li><li><strong>任意函数</strong>：支持加减乘除、比较、逻辑运算等</li></ul><h3 id="mpc-工作流程-5步" tabindex="-1"><a class="header-anchor" href="#mpc-工作流程-5步"><span>MPC 工作流程（5步）</span></a></h3><h4 id="步骤1-问题设定" tabindex="-1"><a class="header-anchor" href="#步骤1-问题设定"><span>步骤1：问题设定</span></a></h4><p>三家银行想知道它们的<strong>平均贷款额度</strong>，但不想暴露各自的具体额度：</p><ul><li>银行 A：100万</li><li>银行 B：200万</li><li>银行 C：300万</li></ul><p>目标：计算平均值 = (100 + 200 + 300) / 3 = 200万</p><h4 id="步骤2-秘密分享-secret-sharing" tabindex="-1"><a class="header-anchor" href="#步骤2-秘密分享-secret-sharing"><span>步骤2：秘密分享（Secret Sharing）</span></a></h4><p>每家银行将自己的数据<strong>分成多份</strong>，分发给其他银行：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">银行 A (100万) 分成3份：</span>
<span class="line">  → 发给自己：35</span>
<span class="line">  → 发给 B：   42</span>
<span class="line">  → 发给 C：   23</span>
<span class="line">  （35 + 42 + 23 = 100）</span>
<span class="line"></span>
<span class="line">银行 B (200万) 分成3份：</span>
<span class="line">  → 发给 A：   67</span>
<span class="line">  → 发给自己： 88</span>
<span class="line">  → 发给 C：   45</span>
<span class="line">  （67 + 88 + 45 = 200）</span>
<span class="line"></span>
<span class="line">银行 C (300万) 分成3份：</span>
<span class="line">  → 发给 A：   98</span>
<span class="line">  → 发给 B：   110</span>
<span class="line">  → 发给自己： 92</span>
<span class="line">  （98 + 110 + 92 = 300）</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>关键</strong>：每一份数据单独看是<strong>随机数</strong>，没有任何意义！</p><h4 id="步骤3-本地计算" tabindex="-1"><a class="header-anchor" href="#步骤3-本地计算"><span>步骤3：本地计算</span></a></h4><p>每家银行对收到的所有分片进行<strong>本地求和</strong>：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">银行 A 手里有：35 (自己的) + 67 (B的) + 98 (C的) = 200</span>
<span class="line">银行 B 手里有：42 (A的) + 88 (自己的) + 110 (C的) = 240</span>
<span class="line">银行 C 手里有：23 (A的) + 45 (B的) + 92 (自己的) = 160</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="步骤4-结果重构" tabindex="-1"><a class="header-anchor" href="#步骤4-结果重构"><span>步骤4：结果重构</span></a></h4><p>三家银行公开各自的计算结果，相加：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">200 + 240 + 160 = 600</span>
<span class="line"></span>
<span class="line">平均值 = 600 / 3 = 200万 ✅</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="步骤5-隐私保证" tabindex="-1"><a class="header-anchor" href="#步骤5-隐私保证"><span>步骤5：隐私保证</span></a></h4><p><strong>整个过程中：</strong></p><ul><li>✅ 每家银行只知道自己的原始数据</li><li>✅ 看到的其他银行的分片都是随机数</li><li>✅ 最终得到了正确的平均值</li><li>✅ 无法推断其他银行的真实数据</li></ul><h3 id="隐私保护的核心" tabindex="-1"><a class="header-anchor" href="#隐私保护的核心"><span>隐私保护的核心</span></a></h3><h4 id="银行-a-的视角" tabindex="-1"><a class="header-anchor" href="#银行-a-的视角"><span>银行 A 的视角</span></a></h4><p><strong>我的数据：</strong> 100万</p><p><strong>我看到的：</strong></p><ul><li>✅ 我自己的分片：35</li><li>✅ B 发来的分片：67（随机数，看不出B的数据）</li><li>✅ C 发来的分片：98（随机数，看不出C的数据）</li><li>✅ 最终平均值：200万</li></ul><p><strong>我看不到的：</strong></p><ul><li>❌ 银行 B 的真实数据：200万</li><li>❌ 银行 C 的真实数据：300万</li><li>❌ 其他银行的其他分片</li></ul><h4 id="银行-b-的视角" tabindex="-1"><a class="header-anchor" href="#银行-b-的视角"><span>银行 B 的视角</span></a></h4><p><strong>我的数据：</strong> 200万</p><p><strong>我看到的：</strong></p><ul><li>✅ 我自己的分片：88</li><li>✅ A 发来的分片：42（随机数）</li><li>✅ C 发来的分片：110（随机数）</li><li>✅ 最终平均值：200万</li></ul><p><strong>我看不到的：</strong></p><ul><li>❌ 银行 A 的真实数据：100万</li><li>❌ 银行 C 的真实数据：300万</li></ul><hr><h2 id="在线交互演示" tabindex="-1"><a class="header-anchor" href="#在线交互演示"><span>在线交互演示</span></a></h2><h3 id="🎯-快速体验-mpc-秘密分享" tabindex="-1"><a class="header-anchor" href="#🎯-快速体验-mpc-秘密分享"><span>🎯 快速体验 MPC 秘密分享</span></a></h3><p>体验 MPC 的核心技术 —— 秘密分享（Secret Sharing），看看如何在不泄露数据的情况下完成联合计算：</p><div id="demo-container" style="max-width:900px;margin:30px auto;padding:30px;background:linear-gradient(135deg, #667eea 0%, #764ba2 100%);border-radius:20px;box-shadow:0 10px 40px rgba(102, 126, 234, 0.3);"><div style="background:white;border-radius:15px;padding:30px;"><h3 style="text-align:center;color:#333;font-size:1.8em;margin-bottom:30px;"> MPC 秘密分享演示 </h3><pre><code>&lt;div style=&quot;display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; margin-bottom: 25px;&quot;&gt;
  &lt;div&gt;
